...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5913184,
    DYNAMIC_BASE = 5913184,
    DYNAMICTOP_PTR = 670048;
...
var wasmBinaryFile = 'prover9.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=670096;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=670144;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 670192, 4), 670192);function _localtime_r(time, tmPtr) {
      _tzset();
