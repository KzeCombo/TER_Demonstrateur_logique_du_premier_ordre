...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5901632,
    DYNAMIC_BASE = 5901632,
    DYNAMICTOP_PTR = 658496;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=658544;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=658592;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 658640, 4), 658640);function _localtime_r(time, tmPtr) {
      _tzset();
